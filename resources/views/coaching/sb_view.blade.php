...
<div class="container-fluid">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-12"><b style="color: #0000FF; font-size: 16px;">View/Update Skill Building Session</b></div>
            </div>
            <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-11">
                                <div class="mb-3">
                                    ...
                                    <input name="sb_skill" type="text" class="form-control"  aria-describedby="Behavior Skill" value="<?php echo $obj['sb_skill'] ?>" <?php echo intval($obj['update'])== 2 ? 'readonly="1"' : "" ?>>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-11">
                                <div class="mb-3">
                                    ...
                                    <input name="sb_when_skill" type="text" class="form-control"  aria-describedby="Behavior Skill" value="<?php echo $obj['sb_when_skill'] ?>" <?php echo intval($obj['update']) == 2 ? 'readonly="1"' : "" ?>>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-11">
                                <div class="mb-3">
                                    ...
                                    <input name="sb_how_skill" type="text" class="form-control"  aria-describedby="Behavior Skill" value="<?php echo $obj['sb_how_skill'] ?>" <?php echo intval($obj['update']) == 2 ? 'readonly="1"' : "" ?>>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-11">
                                <div class="mb-3">
                                    ...
                                    <input name="sb_why_skill" type="text" class="form-control"  aria-describedby="Behavior Skill" value="<?php echo $obj['sb_why_skill'] ?>" <?php echo intval($obj['update']) == 2 ? 'readonly="1"' : "" ?>>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-11">
                                <div class="mb-3">
                                    ...
                                    <textarea name="sb_takeaway" rows="10" class="form-control" <?php echo intval($obj['update']) == 2 ? 'readonly="1"' : "" ?>><?php echo $obj['sb_takeaway'] ?></textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-11">
                                <div class="mb-3">
                                    ...
                                    <input name="sb_timeframe" type="text" class="form-control" <?php echo intval($obj['update']) == 2 ? 'readonly="1"' : "" ?>  aria-describedby="TimeFrame" value="<?php echo $obj['sb_timeframe'] ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-11">
                                <div class="mb-3">
                                    ...
                                    <textarea name="sb_feedback" rows="10" class="form-control"><?php echo $obj['sb_feedback'] ?></textarea>
                                    <div id="sb_feedbackHelp" class="form-text" style="color: red; display: none;">* Feedback is required and necessary.</div>
                                </div>
                            </div>
                        </div>
                        <?php   
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="hidden" name="update" value="<?php echo $obj['update'] ?>">
                                    <?php
                                    if($obj['update'] == 1):
                                    ?>
                                    <input type="submit" name="update_SB_linking" id="btn-process_submit" class="btn btn-lg btn-primary" value="UPDATE SKILL BUILDING SESSION">
                                    <?php
                                    endif;
                                    if($obj['acknowledge'] == 1):
                                    ?>
                                    <input type="submit" name="acknowledge_SB_linking" id="btn-process_submit" class="btn btn-lg btn-primary" value="ACKNOWLEDGE SKILL BUILDING SESSION">
                                    <?php
                                    endif;
                                    ?>
                                </div>

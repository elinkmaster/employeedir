                        ...
                        <div class="col-md-12">
                            ...
                            {{ Form::hidden('_method', 'PUT') }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="event_name" value="{{ $event->event_name }}">
                                </div>
                                <div class="form-group">
                                    <label>Event Description</label>
                                    <input class="form-control" name="event_description" value="{{ $event->event_description }}">
                                </div>
                                <div class="form-group">
                                    <label>Start Date</label>
                                    <input class="form-control" name="start_date" id="start_date" value="{{ timeDate($event->start_date) }}">
                                </div>
                                <div class="form-group">
                                    <label>End Date</label>
                                    <input class="form-control" name="end_date" id="end_date" value="{{ timeDate($event->end_date) }}">
                                </div>
                                <div class="form-group">

                ...
                <div class="pane-body panel">
                    ...
                    <table class="table table-striped" id="leave_credits_table">
                        ...
                        <tr>
                            <th>Employee ID</th>
                            <th>Employee Name</th>
                            <th><?php echo date('Y') - 2  ?> PTO Balance</th>
                            <th><?php echo date('Y') - 2  ?> PTO<br>Conversion</th>
                            <th><?php echo date('Y') - 2 ?> PTO<br>Forwarded</th>
                            <th><?php echo date('Y') - 1 ?> PTO<br>Monthly Accrual</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ number_format($balance - $employee->used_jul_to_dec,1) }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>

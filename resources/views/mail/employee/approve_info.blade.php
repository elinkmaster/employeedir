<div>
    ...
    <br>
    Approval for Update Information Request for: {{ $change_details['name'] }}
    <br>
    <br>
    <?php
        $obj = [
    ...
    <table border="1">
        ...
        <tbody>
            ...
            <tr>
                <td colspan="3" style="text-align: center; padding: 7px;"><a type="button" href="http://dir.elink.corp/approve-request-info/{{ $change_details['id'] }}">Approve Information Change Request</a></td>
            </tr>
        </tbody>
    </table>
    <br>
    <br>
    Please <a href="http://dir.elink.corp/login">login</a> to your account before approving the Information Change Request.
    <br>
    <br>
    Sincerely,
    <br>
